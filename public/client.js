 ...
 */
/* global alert, WebSocket, Handlebars, connectEvent:writable, location, showdown, CustomEvent, XMLHttpRequest */
...
var Botkit = {
  ...
  trigger: function (event, details) {
    var event2 = new CustomEvent(event, {
      detail: details
    })
    this.message_window.dispatchEvent(event2)
  },
  ...
  connectWebsocket: function (wsURL) {
    var that = this
